...
"""GenCeption: Multi-modal video understanding via a single-step diffusion transformer."""
...
from representations4d.genception.utils import compute_pointcloud_framing
